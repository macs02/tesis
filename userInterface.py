...
# ====================== 🎨 ESTILOS COMPATIBLES CON REPLIT ======================
st.markdown("""
<style>
/* Fuente principal compatible */
* {
...
/* Colores biomédicos */
:root {
    --primary: #2A5C7D;      /* Azul médico */
    --secondary: #4CAF50;    /* Verde biomédico */
    --accent: #FF5252;       /* Rojo para alertas */
}
...
# Botón en sidebar para cambiar tema
with st.sidebar:
    st.button("🌓 Cambiar Tema", on_click=toggle_theme)
    if st.session_state.dark_mode:
        st.markdown("<style>[data-testid='stAppViewContainer'] {background-color: #121212 !important; color: white !important;}</style>", unsafe_allow_html=True)
    else:
        st.markdown("<style>[data-testid='stAppViewContainer'] {background-color: white !important; color: #333333 !important;}</style>", unsafe_allow_html=True)
